...
export default function AccordionMenu({ sections, onItemToggle }: CourseContentAccordionProps) {
  ...
  return (
    <div className="border w-full border-gray-300 rounded-lg overflow-clip last:border-b-0">
      {/* Menu Header */}
      <button className="flex justify-between border-b bg-gray-50 border-gray-300 w-full font-medium p-3" onClick={() => setexpandedCourse(!expandedCourse)} aria-expanded={expandedCourse}>
